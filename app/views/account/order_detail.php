...
<a href="<?php echo BASE_URL; ?>index.php?controller=account&action=history">Quay lại Lịch sử</a>
<hr>
...
<p><strong>Ghi chú:</strong> <?php echo htmlspecialchars($order['notes'] ?? ''); ?></p>
    ...
    -->
    <?php
    // Tính toán lại tổng tiền hàng (vì total_amount trong CSDL là TỔNG CUỐI)
    // Tổng tiền hàng = Tổng cuối + Tiền đã giảm
